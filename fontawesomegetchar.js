 ...
 *                                                                                *
 * This file is part of FontAwesomeGetChar.                                       *
 *                                                                                *
 * FontAwesomeGetChar is free software: you can redistribute it and/or modify     *
 * it under the terms of the GNU Lesser General Public License as published by    *
 * the Free Software Foundation, either version 3 of the License, or              *
 * (at your option) any later version.                                            *
 *                                                                                *
 * FontAwesomeGetChar is distributed in the hope that it will be useful,          *
 * but WITHOUT ANY WARRANTY; without even the implied warranty of                 *
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the                  *
 * GNU Lesser General Public License for more details.                            *
 *                                                                                *
 * You should have received a copy of the GNU Lesser General Public License       *
 * along with FontAwesomeGetChar.  If not, see <http://www.gnu.org/licenses/>.    *
 **********************************************************************************/
...
function getChar(charName) {
    ...
    case "fa-video-camera" :
        return "\uf03d"
    case "fa-photo:before" :
    case "fa-image:before" :
    case "fa-picture-o" :
        return "\uf03e"
    case "fa-pencil" :
        return "\uf040"
